<template>
    ...
    <LapPhoneAttribute 
        :size="prduct.prod_size_inch"
        @parent-change-product-size ="productChangeSize"
...
import LapPhoneAttribute from '@/components/product/lapPhone/LapPhoneAttribute.vue'
...
export default{
  ...
  methods:{
    productChangeSize(productSize: any){
       // console.log(sexChanged)
        this.prduct.prod_size_inch =productSize
    },
    //--------
    ...
    save(){
        ...
        $('.prd_att').each(function(){
            quantity += Number($(this).find('.prd_size_s').val())
            prd_att_item = {
